...
TEMPLATES = [
    {
        ...
        'DIRS': [os.path.join(BASE_DIR, 'track_field_project', 'templates'), os.path.join(BASE_DIR, 'analytics', 'templates'), 'athletics/templates', 'geography/templates', 'identity/templates', 'utility/templates'],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
