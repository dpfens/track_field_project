...
class RequestLoggingMiddleware(object):
    ...
    def __call__(self, request):
        ...
        try:
            ...
            method = models.RequestMethod(name=request.method, created_by_id=identity)
            method.save()
        ...
        try:
            ...
            ip_address = models.IpAddress(ip_address_type=ip_address_type, value=raw_ip_address, created_by_id=identity)
            ip_address.save()
        ...
        try:
            ...
            device_type = models.DeviceType(name=device_family, description='', created_by_id=identity)
            device_type.save()
        ...
        try:
            ...
            device = models.Device(device_type=device_type, name=device_family, created_by_id=identity)
            device.save()
        ...
        try:
            ...
            for version_type, version in zip(version_keys, request.user_agent.os.version):
                versions[version_type] = version
            operating_system = models.OperatingSystem(name=request.user_agent.os.family, version=request.user_agent.os.version_string, created_by_id=identity, **versions)
        ...
        if raw_referrer:
            try:
                ...
                try:
                    ...
                    referrer_type = models.ReferrerType(name=raw_referrer_type, created_by_id=identity)
                    referrer_type.save()
                referrer = models.Referrer(value=raw_referrer, referrer_type=referrer_type, created_by_id=identity)
                referrer.save()
        ...
        try:
            ...
            request_type = models.RequestType(name=raw_request_type, description='', created_by_id=identity)
            request_type.save()
